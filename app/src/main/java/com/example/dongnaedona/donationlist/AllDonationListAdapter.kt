...
class AllDonationListAdapter(
    private var donationListArray: ArrayList<DonationInfo>
): RecyclerView.Adapter<AllDonationListAdapter.MyViewHolder>(){
...
//    ex) '나'의 기부 리스트 => Filterable
    ...
    override fun onCreateViewHolder(
        ...
        val v = LayoutInflater.from(parent.context)
            .inflate(R.layout.all_donation_list_row, parent, false)
    ...
    inner class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        var goodsImageView = itemView.findViewById(R.id.goods_image) as ImageView
