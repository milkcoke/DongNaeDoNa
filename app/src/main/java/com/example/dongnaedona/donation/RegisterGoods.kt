...
//        입력값 초기화
    ...
    private fun imageSelectButtonInitialize() {
        add_photo_button.setOnClickListener {
            ...
            startActivityForResult(pickPhotoIntent, REQUEST_CODE);
    ...
    private fun inputLayoutInitialize() {
        ...
        goods_name_editText.hint = resources.getString(R.string.goods_name_hint)
        goods_name_inputLayout.error = null
        goods_name_inputLayout.clearFocus()

        goods_description_editText.text?.clear()
        goods_description_editText.hint = resources.getString(R.string.goods_description_hint)
        ...
        donation_method_autoCompleteTextView.hint = resources.getString(R.string.donation_method_hint)
    }
